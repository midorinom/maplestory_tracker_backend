...
class EventsCharacterShops(db.Model):
    __tablename__ = "events_character_shops"
...
class EventsCharacterShopsSchema(Schema):
    uuid = fields.UUID()
    region = fields.Str()
    currency = fields.Str()
    item = fields.Str()
...
events_character_shops_schema = EventsCharacterShopsSchema()
